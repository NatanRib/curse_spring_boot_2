...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2021-05-18T15:12:54Z"), u4);
		Order o2 = new Order(null, Instant.parse("2020-06-15T08:11:44Z"), u1);
		Order o3 = new Order(null, Instant.parse("2021-01-01T11:10:34Z"), u3);
		Order o4 = new Order(null, Instant.parse("2020-07-13T19:10:54Z"), u4);
		Order o5 = new Order(null, Instant.parse("1998-07-25T03:12:54Z"), u2);
		Order o6 = new Order(null, Instant.parse("2005-12-25T15:12:54Z"), u4);
		Order o7 = new Order(null, Instant.parse("2004-05-18T15:12:54Z"), u2);
		Order o8 = new Order(null, Instant.parse("2020-05-18T15:12:54Z"), u3);
